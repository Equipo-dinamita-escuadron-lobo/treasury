...
public class PayableWriteOff {
    ...
    public void voidWriteOff() { if (status != WriteOffStatus.POSTED && status != WriteOffStatus.VOID_FAILED) conflict("Solo se anulan bajas contabilizadas o con anulaciÃ³n fallida"); status = WriteOffStatus.VOIDING; }
