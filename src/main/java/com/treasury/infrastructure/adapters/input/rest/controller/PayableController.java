...
public class PayableController {
    ...
    private final WriteOffResponseAssembler writeOffAssembler;
    ...
    @PostMapping("/payables/{id}/reconcile-balance")public PayableResponse reconcileBalance(@PathVariable Long id,@RequestParam String enterpriseId){return payableMapper.toResponse(commands.reconcileBalance(id,enterpriseId));}
    @PostMapping("/payables/reconcile-supplier")public ReconcileSupplierResponse reconcileSupplier(@RequestParam String enterpriseId,@RequestParam Long supplierId){return new ReconcileSupplierResponse(commands.reconcileSupplierBalances(enterpriseId,supplierId));}
